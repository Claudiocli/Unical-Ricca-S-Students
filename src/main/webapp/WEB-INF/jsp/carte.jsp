                        ...
                        <div class="col-lg-8 col-md-8 h-100 elenco-carte-font text-center">
                            <div>
                                <ul class="list-inline mb-2 list-font">
                                    ...
                                    <li id="form" hidden>
                                        <form class="font-form">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div id="emailHelp" class="form-text">Noi non condividiamo con nessuno
                                                    la
                                                    tua mail...</div>
                                            </div>
                                            <ul class="list-inline-item scadenza-cvc-padding">
                                                        ...
                                                        <ul class="list-inline mb-2">
                                                            <li class="list-inline-item scadenza-width">
                                                                <input type="number" class="form-control"
                                                                    placeholder="mm" id="mese">
                                                            </li>
                                                            <li class="list-inline-item scadenza-width">
                                                                <input type="number" class="form-control"
                                                                    placeholder="aa" id="anno">
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </li>
                                                <li class="list-inline-item cvc-padding">
                                                    <div class="mb-3">
                                                        ...
                                                        <ul class="list-inline mb-2">
                                                            <li class="list-inline-item cvc-width">
                                    ...
                                    <li class="list-inline-item">
                                        <p class="vx_text-body-sm">Usa il tuo saldo per fare acquisti e inviare denaro.
                                        </p>
                                    </li>
                                    <li class="list-inline-item">
