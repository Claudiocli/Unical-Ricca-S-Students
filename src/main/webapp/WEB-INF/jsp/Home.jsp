...
<!-- Firebase products -->
<script
	src="https://www.gstatic.com/firebasejs/8.2.3/firebase-analytics.js"></script>
		...
		<div class="container">
			<div class="row w-100">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							<li class="nav-item"><img class="logo-font"
								src="../../resources/img/LOGO PAY8BALL_LOGO ORIZZONTALE.png"
								alt="logo"></li>
				...
				<div class="col-lg-1 col-md-1">
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							<li class="nav-item"><input type="image" class="btn"
								id="notifications"
									...
									<ul class="list-inline mb-2 list-font">
										<li id="form">
											<form class="font-form">
												...
												<button id="submitColletta" type="button"
													class="btn submit-font" data-bs-toggle="modal"
														...
														<div class="modal-content">
															...
															<div class="modal-footer">
																<button id="bottoneAnnullaColletta" type="button"
																	class="btn btn-secondary" data-bs-dismiss="modal">Annulla</button>
	...
	<div id="friend-info-popup" class="friendModal">
		<div class="friend-modal-content">
			<span class="friend-popup-close">&times;</span> </br> <label
				class="form-label modal-label-info" id="friend-id-info">ID:
			</label> <label class="form-label modal-label-info" id="friend-name-info">Nome:
			</label>
