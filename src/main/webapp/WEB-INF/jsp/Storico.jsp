                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Chiudi</button>
                                                    <button type="button" class="btn esci-font" id="btn-logout">S&igrave;</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div>
                            ...
                            <h3>Veloce</h3>
                            <p class="lead mb-0 text-bold"> Certificato come conto virtuale pi&ugrave; rapido in Europa.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 ">
                        <div>
                            ...
                            <h3>Sicuro</h3>
                            <p class="lead mb-0 text-bold"> Eccetto noi della PayBall8 S.P.A. nessuno pu&ograve; accedere ai
                                vostri
                                dati sensibili ;-) .</p>
                        </div>
                    </div>
