            ...
            <div class="col-lg-8 col-md-8 col-sm-8 h-100">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                      ...
                      <li class="page-item "><a class="page-link nav-bar-pages" href="#">1</a></li>
                      <li class="page-item "><a class="page-link nav-bar-pages" href="#">2</a></li>
                      <li class="page-item "><a class="page-link nav-bar-pages" href="#">3</a></li>
                      <li class="page-item ">
